...
const CuandoEstamosJuntas = (props) => {
  ...
  return (
    <Wrapper className={props.className}>
      <Number src={require('../../../assets/imgs/cuando-estamos-juntas/number.jpg')} width={100} x={500} y={600} />
      ...
      <Leaves width={898} height={294} x={100} y={100} src={require('../../../assets/imgs/cuando-estamos-juntas/leaves.jpg')} />
    </Wrapper>
  );
}
